<template>
	...
	<div class="thumbnail1">
			<li><a href="/more/study/1/1.html" :title="item.title" target="_blank"><i><img src="http://www.yangqq.com/d/file/news/life/2018-04-27/762f99f369ae786f970477feeb3b9d77.jpg"></i>
	...
	<div class="article" v-html="item.article"><!-- 文章渲染 -->
		...
		<span class="pre"><svg viewBox="0 0 24 24" class="mu-pagination-svg-icon"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></svg></span>
		<div class="btnlist"><span v-for="index in totalpages" :key='index' @click="openpage(index)" :class="{activecolor:index==isactive}">{{index}}</span> </div>	
			<span class="next"><svg viewBox="0 0 24 24" class="mu-pagination-svg-icon"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path></svg></span>
			 </div>
